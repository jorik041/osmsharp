...
namespace OsmSharp.Routing.TSP
{
        ...
        where RouterTSPType : RouterTSP
    {
        ...
        /// Holds the router.
        /// </summary>
        private readonly IRouter<ResolvedType> _router;

        /// <summary>
        /// Holds the router TSP.
        /// </summary>
        private readonly RouterTSPType _router_tsp;
        ...
        /// </summary>
        /// <param name="router_tsp">The TSP solver.</param>
        ...
        /// <param name="router_tsp">The TSP solver.</param>
        /// <param name="router">The router.</param>
        /// <param name="interpreter">The routing interpreter to calculate time/distances.</param>
        public RouterTSPWrapper(RouterTSPType router_tsp, IRouter<ResolvedType> router, IRoutingInterpreter interpreter)
        {
            _router = router;
            _router_tsp = router_tsp;
