...
namespace OsmSharp.Tools.Collections
{
    ...
    public class ObjectTable<Type>
    {
		...
		public ObjectTable(bool reverse_index, int init_capacity, Type[] strings)
		{
			_strings = strings;
			_init_capacity = init_capacity;
		...
		/// Holds the initial capacity and is also used as an allocation step.
		/// </summary>
		public int InitCapacity { get { return _init_capacity; } }
		...
		public uint Count
		{
			get { return _next_idx; }
		}
		
		/// <summary>
		/// HReturns true if the reverse index is enabled
		/// </summary>
		public bool IsReverseIndexed { get { return _reverse_index != null; } }
